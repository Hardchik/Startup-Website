    ...
    <div className="bg-white">
      ...
      <main className="isolate">
                  ...
                  <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                    <div className="relative">
                      <img
                        ...
                        src='https://images.news18.com/ibnlive/uploads/2023/02/medical-device-industry-budget-2023.jpg'
                        alt=""
                  ...
                  <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                    <div className="relative">
                      <img
                        ...
                        src='https://images.thequint.com/thequint%2F2021-06%2F89343c8a-184f-440f-877a-eef6c2d6a776%2Fimgonline_com_ua_resize_9ukcp0fQkgeBaToq.jpg?auto=format%2Ccompress&fmt=webp&width=230&w=1200'
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                    ...
                    <div className="relative">
                      <img
                        ...
                        src='https://as2.ftcdn.net/v2/jpg/02/61/06/21/1000_F_261062191_uPGCcQNlETNSgTKzzYaDqJCeSow0RJKB.jpg'
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                  ...
                  <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                    <div className="relative">
                      <img
                        ...
                        src='https://i.pinimg.com/736x/fc/6d/4b/fc6d4bea0960c518be97c579c3aa42bc.jpg'
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                    ...
                    <div className="relative">
                      <img
                        ...
                        src='https://img.freepik.com/premium-vector/doctors-nurses-paramedics-characters-icons-group-medical-staff-hospital-team-medicine-banner_153629-116.jpg'
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
        ...
        <div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
          <img
            // src="https://img.freepik.com/free-vector/medical-technology-vector-icon-set-health-wellness_53876-110853.jpg"
            // src="https://www.asterhospitals.in/sites/default/files/2022-05/internal-medicine-hospital-in-guntur.jpg"
            src='https://www.chaudharyhospital.in/wp-content/uploads/2020/11/WhatsApp-Image-2020-11-09-at-4.41.29-PM-1.jpeg'
        ...
        {/* Logo cloud */}
        <div className="relative isolate -z-10 mt-32 sm:mt-48 my-20" >
